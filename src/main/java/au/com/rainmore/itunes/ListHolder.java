...
public class ListHolder {
    ...
    public void run(DataInputStream dis) throws IOException {
        ...
        switch ((int) this.type) {
            case ListHolderType.Album_List:
                AlbumList.run(dis);
                break;
            case ListHolderType.Song_List:
                SongList.run(dis);
                break;
            case ListHolderType.Podcast_List:
                PodcastList.run(dis);
                break;
            case ListHolderType.Playlist_List:
                PlaylistList.run(dis);
                break;
            case ListHolderType.SmartPlaylist_List:
                SmartPlaylistList.run(dis);
                break;
        }
    }
}
